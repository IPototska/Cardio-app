...
class Workout {
  ...
  _setDescription() {
    this.type === 'running' ? (this.description = `Пробіжка ${new Intl.DateTimeFormat('ru-Ru').format(this.date)}`) : (this.description = `Велотренування ${new Intl.DateTimeFormat('ru-Ru').format(this.date)}`);
  }
    ...
    let html = `
        <li class="workout workout--${workout.type}" data-id="${workout.id}">
          ...
          <div class="workout__details">
            <span class="workout__icon">${workout.type === 'runnng' ? '🏃' : '🚵‍♂️'}</span>
